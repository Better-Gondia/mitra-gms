...
const departmentRoles: Role[] = [
  ...
  Role.RDC_GONDIA,
  Role.DEPUTY_COLLECTOR_GENERAL_GONDIA,
  Role.PO_OFFICE_DEORI,
  Role.ST_DEPO_OFFICE_GONDIA,
  Role.NAGAR_PANCHAYAT_SALEKASA,
  Role.NAGAR_PANCHAYAT_DEORI,
  Role.NAGAR_PANCHAYAT_ARJUNI_MOR,
  Role.NAGAR_PANCHAYAT_SADAK_ARJUNI,
];
